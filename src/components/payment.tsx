        ...
        >
          ...
          >
            ...
            {step !== "success" && (
              ...
              >
                <div>
                  <div style={{ fontSize: 11.5, color: "#667085", marginBottom: 2 }}>
                    {description}
                  </div>
                  <div style={{ fontSize: 11, color: "#9BA8C0" }}>Type timbre: {typeTimbre}</div>
                </div>
                <div
                  style={{
                    fontSize: 20,
            ...
            <div style={{ padding: "20px 24px 24px" }}>
              ...
              {step == "error" && (
                <div style={{ textAlign: "center", padding: "16px 0 8px" }}>
                  ...
                  >
                    <svg width="36" height="36" viewBox="0 0 36 36" fill="none">
                      <circle cx="18" cy="18" r="17" stroke="#BF0D0D" strokeWidth="2" />
                      <path
                  ...
                  <div style={{ fontSize: 13, color: "#884646", marginBottom: 20, lineHeight: 1.5 }}>
                    Votre paiement de <strong>{formatAmount(amount)}</strong> a echouer.
                  </div>
                  ...
                  >
                    ...
                    <div style={{ display: "flex", justifyContent: "space-between" }}>
                      <span style={{ fontSize: 13, color: "#667085" }}>Type de timbre</span>
                      <span style={{ fontSize: 12, fontWeight: 600, color: "#0066CC", fontFamily: "monospace" }}>
                        {typeTimbre}
                      </span>
                    </div>
